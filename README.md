...
Event 5 được xây dựng để tự động quản lý trạng thái:
...
thông qua Trigger trong SQL Server.

Việc sử dụng Trigger giúp hệ thống:
...
<img width="1920" height="1080" alt="Screenshot 2026-05-08 220802" src="https://github.com/user-attachments/assets/d71609e4-e2da-4246-9ea6-b1ca4d7f9bbd" />
...
Các Trigger hỗ trợ cập nhật trạng thái hợp đồng và tài sản theo thời gian thực, giúp hệ thống hoạt động chính xác, đồng bộ và giảm sai sót khi quản lý thủ công.
